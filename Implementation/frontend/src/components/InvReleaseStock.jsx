...
export default function InvReleaseStock() {
  ...
  async function handleRelease(
    { item_code, item_name, item_brand, category, qty },
    newQty
  ) {
    console.log(newQty);
    if (qty < 1) {
      ...
      await axios
        ...
        .then(() => {
          toast.success(
            `Sucessfully released ${newQty} ${item_brand} ${item_name}s`,
            { position: toast.POSITION.BOTTOM_RIGHT }
          );
        })
        .catch((err) => {
      ...
      await axios
        ...
        .then(() => {
          ...
          if (updatedQty === 0) {
            toast.error(`${item_code} is out of stock`, {
              position: toast.POSITION.BOTTOM_RIGHT,
            });
          }
        })
                        ...
                        <tr className="hover:bg-[#efeeee]">
                          ...
                          <td className="p-3">
                            <button
                              ...
                              onClick={() => handleRelease(item, newQty)}
                            >
                              Release
                            </button>
                          </td>
