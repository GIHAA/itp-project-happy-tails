...
export default function UpdateStockBudgetRequest(){
  ...
  const [total,setTotal] = useState(0)
    ...
    async function getRequest() {
        try {
          const res = await axios.get(`http://localhost:8080/api/stockBudget/${id}`);
          console.log(res);
    ...
    useEffect(() => {
      ...
      async function UpdateData(e){
        ...
        const newReq = {
         ...
         console.log(newReq)
       await axios.put(`http://localhost:8080/api/stockBudget/${id}`,newReq)
       .then(()=>{
        toast.success("Request details updated", {position: toast.POSITION.TOP_RIGHT,})
      })
        ...
        <div className="flex scroll-smooth">
          ...
          <div className="bg-[#d9d9d9] flex-[85%]">
            <div className="bg-[#2E4960] h-100 w-full">
              <h1 className="text-white font-bold text-3xl leading-5 tracking-wide pt-5 pl-5">UPDATE REQUEST INFORMATION</h1>
              <div className=" flex p-5"></div>
            </div>
            <div  style={{ backgroundImage: `url(${stockBgt})` }} className="bg-cover bg-center h-screen w-full fixed">
              <div className=" bg-white bg-opacity-90 w-[75%] h-[80%] absolute top-5 left-[80px] overflow-scroll">
                <div className="w-[800px] mx-auto rounded-2xl bg-white mt-8">
                  <h1 className="text-[#ffffff] bg-[#FF9F00] rounded-t-2xl font-bold text-3xl h-20 mb-4 pt-5 text-center drop-shadow-md">Enter New Details</h1>
                      ...
                      <div className="flex mb-10">
                        <div  className=" w-[50%] ">
                          ...
                          <input
                            ...
                            value={supplier_name} onChange={(e) => {
