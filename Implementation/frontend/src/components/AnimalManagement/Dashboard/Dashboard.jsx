...
function Dashboard() {
  ...
  return (
    <div className="bg-gray-200">
      ...
      <div id="wrapper" class="ml-[300px] mt-[70px] px-4 py-4 mx-auto">
        <div class="sm:grid sm:h-32 mr-[50px] sm:grid-flow-row sm:gap-4 sm:grid-cols-5 ">
          <div
            ...
            class="flex flex-col justify-center px-4 py-4 bg-[#f5f5f5] shadow-md border border-gray-300 rounded"
          >
            <div>
              <div>
              ...
              <p class="text-lg pt-2 text-center text-gray-500">
                Normal Health
              </p>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <p class="text-lg text-center pt-2 text-gray-500">
                Critical Health
              </p>
            </div>
          </div>
          ...
          <div
            ...
            class="flex flex-col justify-center px-4 py-4 mt-4 bg-[#f5f5f5] shadow-md border border-gray-300 rounded sm:mt-0"
          >
            <div>
              <div>
          ...
          >
            <div>
              ...
              <p class="text-lg text-center pt-2 text-gray-500">Adopted Pets</p>
            </div>
          </div>
      ...
      <div class="w-full mt-5 ml-[1000px] h-[500px] max-w-md  p-4 bg-[#f5f5f5] shadow-md border border-gray-200 rounded-lg  sm:p-8 ">
        <div class="flex items-center justify-between mb-4">
          <h5 class="text-xl font-bold leading-none text-Black ">
            Latest Pets
          </h5>
          <Link
