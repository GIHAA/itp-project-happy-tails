...
const Employee = (props) => (
  <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
    ...
    <td className="px-6 py-4">{props.employee.roles}</td>
      ...
      <div class="flex justify-center">
        <div class="">
          <button
            ...
            onClick={() => {
              props.gotoUpdateEmployee(props.employee._id);
            }}
          >
            <div class="">
              <svg
...
export class EmployeeList extends Component {
  ...
  searchEmployeeList() {
    return this.state.employee.map((currentemployee) => {
      if (this.state.searchEmployee == currentemployee.firstName) {
        return (
          // <tr>
          ...
          //     <td style={{ width: "10%" }}>{currentemployee.roles}</td>
          //     <td style={{ width: "20%" }}>
          //         {
          ...
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td className="px-6 py-4">
              {currentemployee.dob.substring(0, 10)}
            </td>
            <td className="px-6 py-4">{currentemployee.roles}</td>
            <td className="px-6 py-4">
              <div class="flex justify-center">
                <div class="">
                  {
                    <button
                      className="inline-flex items-center px-4 py-2 ml-1 text-sm font-medium text-white duration-100 bg-indigo-500 rounded-md hover:bg-blue-200"
                      onClick={() => {
                        this.gotoUpdateEmployee(currentemployee._id);
                      }}
                    >
                      <div class="">
                        <svg
  ...
  exportEmployee = () => {
    ...
    const emp = this.state.employee.map((Employee) => [
      Employee.firstName,
      Employee.lastName,
      Employee.age,
      Employee.address,
                  ...
                  <tr>
                    ...
                    <td className="flex justify-end gap-2">
                      <div class="flex justify-end sm:flex-row sm:text-left sm:justify-end gap-2">
                        <button class="items-center px-5 py-1 mr-5 bg-[#2E4960] text-white font-semibold hover:bg-[#1b3348] rounded-xl">
                          <Link
                        ...
                        <button
                          class="flex items-center px-5 py-1 mr-5 bg-[#2E4960] text-white font-semibold hover:bg-[#1b3348] rounded-xl"
                      ...
                      <div class="flex justify-end sm:flex-row sm:text-left sm:justify-end">
                        <input
                          className="rounded-3xl py-2.5 px-5 w-[40vh] text-sm text-gray-900 bg-[#E4EBF7] border-0 border-b-2 border-gray-300 appearance-non focus:outline-none focus:ring-0 focus:border-[#FF9F00]"
                          type="text"
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  <thead className=" bg-[#FF9F00] text-white">
                    <tr>
                      ...
                      <th className="p-2 tbhead">roles</th>
