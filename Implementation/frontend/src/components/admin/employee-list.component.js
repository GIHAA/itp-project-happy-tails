...
export class EmployeeList extends Component {
    ...
    exportEmployee = () => {
        ...
        const headers = [["First Name", "Last Name", "Age", "Address", "Phone", "Date Of Birth", "roles"]];
                                    ...
                                    <tr>
                                        ...
                                        <td className='flex justify-end gap-2'>
                                            <div class="flex justify-end sm:flex-row sm:text-left sm:justify-end gap-2">
                                                ...
                                                <button class="flex items-center px-5 py-1 mr-5 bg-[#2E4960] text-white font-semibold hover:bg-[#1b3348] rounded-xl" onClick={() => this.exportEmployee()}>
                                                    <div class="">
                                                        <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
