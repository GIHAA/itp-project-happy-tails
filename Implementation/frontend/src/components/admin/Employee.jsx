        ...
        <div className="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white rounded-lg p-8">
            ...
            <label className="font-semibold text-sm text-gray-600 pb-1 block">Add Name</label>
              ...
              <label className="font-semibold text-sm text-gray-600 pb-1 block">Retype Password</label>
              <input  id="password" name="password" value={about} onChange={onChange} type="text" className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
