...
export default function UpdateSupplier(){
    ...
    useEffect(() => {
      ...
      async function UpdateData(e){
       ...
       await axios.put(`http://localhost:8080/api/suppliers/${id}`,newSupplier)
       .then(()=>{
        ...
        <div className="flex scroll-smooth">
          ...
          <div className="bg-[#d9d9d9] flex-[85%]">
            <div className="bg-[#2E4960] h-100 w-full">
              <h1 className="text-white font-bold text-3xl leading-5 tracking-wide pt-5 pl-5">UPDATE SUPPLIER INFORMATION</h1>
