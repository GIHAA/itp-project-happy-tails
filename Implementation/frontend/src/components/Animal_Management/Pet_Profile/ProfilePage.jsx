      ...
      <div>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <button
            ...
            onClick={() => {
              axios
                .delete(`http://localhost:8080/api/vet/deleteprofile/${pid}`)
                .then((res) => {})
                .catch((err) => {
                  toast.warning(err);
                });
    ...
    <>
      <div class="overflow-hidden bg-secondary shadow sm:rounded-3xl max-w-screen-lg mx-auto mt-28 mb- ml-96">
        ...
        <div class="border-t border-gray-200">
          <dl>
            ...
            <div class="bg-[#D9D9D9] px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt class="text-lg  text-black font-bold ml-16">
                Current Status
              </dt>
              <dd class="mt-1 text-lg  text-black  sm:col-span-2 sm:mt-0">
                {Profile.petStatus}
      ...
      <div className="ml-[1130px] -mt-[70px]">
        <button
          ...
          class="bg-green-400 hover:bg-lime-700 text-gray-800 font-bold py-2 px-4 rounded-full inline-flex items-center"
        >
          <svg
      ...
      <div class="-mt-[600px] ml-[260px] absolute w-[80px]">
        <button
          onClick={onDelete}
          class="text-white bg-red-500 hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-sm px-3.5 py-2 text-center mt-5 mb-4 ml-[1045px]"
        >
          Delete
        </button>
      </div>
      ...
      <img
        className=" w-48 ml-[1100px] -mt-[255px] "
        src={`data:image/png;base64,${qrCode}`}
        alt="QR code"
      />

      <img
        className=" w-48 ml-[1100px] -mt-[415px] rounded-md "
        width={600}
        height={600}
        src={Profile.image}
      />
