...
export default function Availabilities() {
  ...
  function generatePDF() {
    ...
    doc.autoTable({
      ...
      body: availabilities.map((availability) => [availability.plateNo, availability.reason, availability.since, availability.to, availability.status]),
    });
       ...
       //Main container
        ...
        <div className="bg-[#d9d9d9] flex-[85%]">
          ...
          <div className="bg-[#2E4960] h-100 w-full">
            <h1 className="text-white font-bold text-3xl leading-5 tracking-wide pt-5 pl-5 ">MAINTENANCE & AVAILABILITIES</h1>
...
function onDelete(id) {
  ...
  axios.delete(`http://localhost:8080/api/availability/${id}`)
  .then((res) => {
