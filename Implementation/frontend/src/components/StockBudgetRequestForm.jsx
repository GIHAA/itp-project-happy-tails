...
export default function StockBudgetRequestForm() {
  ...
  function addRequest(e) {
    ...
    axios.post("http://localhost:8080/api/stockBudget/", newRequest)
    .then(()=>{
  ...
  return (
    <div className="flex scroll-smooth">
      ...
      <div className="bg-[#d9d9d9] flex-[85%]">
        ...
        <h1 className="text-white font-bold text-3xl leading-5 tracking-wide pt-5 pl-5">NEW BUDGET REQUEST</h1>
        ...
        <div style={{ backgroundImage: `url(${stockBgt})` }} className="bg-cover bg-center h-screen w-full fixed">
          <div className=" bg-white bg-opacity-90 w-[75%] h-[80%] absolute top-5 left-[80px] overflow-scroll">
            <div className="w-[800px] mx-auto rounded-2xl bg-white mt-9">
              <h1 className="text-[#ffffff] bg-[#FF9F00] rounded-t-2xl font-bold text-3xl h-20 mb-4 pt-5 text-center drop-shadow-md">Enter Budget Details</h1>
              <div></div>
              ...
              <div className="flex mt-8 h-10">
                  ...
                  <button type="reset" className="text-white bg-[#FF9F00] hover:bg-[#2E4960] focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-3xl text-l sm:w-auto px-20 py-5.5 text-center ml-[130px] mb-[10px] mt-[-8px]">
                    <Link to='../StockBudgetRequests'>Cancel</Link></button>
