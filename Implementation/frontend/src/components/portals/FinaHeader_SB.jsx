...
<nav className="bg-[#2E4960] border-gray-200 px-2 sm:px-4 py-2.5  fixed top-0 left-0 w-full z-5">
      ...
      <aside id="default-sidebar" class="fixed top-0 left-0 z-[100] w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-[#FF9F00]">
          ...
          <div className="my-6 ">
            ...
            <Link to="/FinaDashBoard/GetTransaction"
            ...
            <Link to="/FinaDashBoard/GetBooking"
              className=" bg-[#2E4960] hover:bg-[#797979] px-[15px] py-[8px] rounded-[120px] font-bold text-white text-[10px] block w-[150px] text-center mb-7 mx-auto"
            >BOOKINGS</Link>

            <Link to='/FinaDashBoard/GetPayment'
              className=" bg-[#2E4960] hover:bg-[#797979] px-[15px] py-[8px] rounded-[120px] font-bold text-white text-[10px] block w-[150px] text-center mb-7 mx-auto"
            >PAYMENT</Link>

            <Link to='/FinaDashBoard/GetDoanation'
              className=" bg-[#2E4960] hover:bg-[#797979] px-[15px] py-[8px] rounded-[120px] font-bold text-white text-[10px] block w-[150px] text-center mb-7 mx-auto"
            >DONATIONS</Link>

            <Link to='/FinaDashBoard/GetOrganization'
              className=" bg-[#2E4960] hover:bg-[#797979] px-[15px] py-[8px] rounded-[120px] font-bold text-white text-[10px] block w-[150px] text-center mb-7 mx-auto"
            >ORGANIZATIONS</Link>
