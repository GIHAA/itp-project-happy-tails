...
export default function EventPortal() {
  ...
  return (
    <>
      ...
      <aside
        id="default-sidebar"
        class="fixed top-0 left-0 z-[96] w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
