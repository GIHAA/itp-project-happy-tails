          ...
          <div class="fixed ">
            <div class="mt-[40px] absolute ml-[275px] ">
              <select
                ...
                class="bg-[#2E4960] border -ml-[100px] border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-15 p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              >
            ...
            <form class="flex items-center mt-10">
              ...
              <div class="relative w-1/2 ml-[270px]">
                ...
                <input
                  ...
                  class="bg-white w-[270px] border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-10 p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  placeholder="Search"
                  required
                />
              </div>
              ...
              <tbody className="divide-y divide-gray-400">
                {report
                  .filter((r) =>
                    filterOption === "all"
                      ? true
                      : r.currentHealthStatus === filterOption
                  )
                  .map((report, index) => (
                    <tr key={index} class="bg-gray-200 hover:bg-slate-100">
                      <td class="px-6 py-4 text-center">{report.petId}</td>
                      ...
                      <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                          <Link
                            to={`/petprofile/displayhealth/${report.petId}`}
                          >
