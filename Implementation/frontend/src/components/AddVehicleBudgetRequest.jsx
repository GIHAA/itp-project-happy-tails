       ...
       //Main container
        ...
        <div className="bg-[#d9d9d9] flex-[85%]">
          ...
          <div className="bg-[#2E4960] h-100 w-full">
            <h1 className="text-white font-bold text-3xl leading-5 tracking-wide pt-5 pl-5 ">ADD NEW REQUEST</h1>
                    ...
                    <div className=" pl-5">
                        ...
                        <form className="mx-auto" onSubmit={addRequest}>
                                ...
                                <div className="flex mb-6">
                                    <div>
                                        <label className="">Title Of Request :</label>
                                        <input type="text" 
                                        ...
                                        onChange={(e)=>{
                                            setReq_title(e.target.value)}} required />                        
                                    </div>
                                ...
                                <div className="flex mb-6">
                                    ...
                                    <div className=" w-[50%]  ">
                                        ...
                                        className=" rounded-3xl py-2.5 px-5 w-[50vh] text-sm text-gray-900 bg-[#E4EBF7] border-0 border-b-2 border-gray-300 appearance-non focus:outline-none focus:ring-0 focus:border-[#FF9F00]" 
                                        onChange={(e)=>{
                                            setPayment(e.target.value)}} required />                        
                                    </div>
                                ...
                                <div className="flex mt-24 h-10">
                                    ...
                                    <button className="text-white bg-[#FF9F00] hover:bg-[#2E4960] focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-3xl text-l sm:w-auto px-20 py-5.5 text-center ml-[100px]"><Link to='/vbudgets'>Cancel</Link></button>
