    ...
    function addItem(e) {
        ...
        .then(()=>{
            ...
            if(err.response.status === 409)
                ...
                alert(`Item insert unsuccessful ${err}`)
       })
       ...
       //Main container
        ...
        <div className="bg-[#d9d9d9] flex-[85%]">
          ...
          <div className="bg-[#2E4960] h-100 w-full">
            <h1 className="text-white font-bold text-3xl leading-5 tracking-wide pt-5 pl-5 ">ADD ITEMS</h1>
                        ...
                        <form className="mx-auto" onSubmit={addItem}>
                                ...
                                <div className="flex mb-6">
                                    <div>
                                        ...
                                        onChange={(e)=>{
                                            setItemCode(e.target.value)}} required />                        
                                    </div>
                                ...
                                <div className="flex mt-24 h-10">
                                    ...
                                    <button className="text-white bg-[#FF9F00] hover:bg-[#2E4960] focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-3xl text-l sm:w-auto px-20 py-5.5 text-center ml-[100px]"><Link to='/inventory'>Cancel</Link></button>
