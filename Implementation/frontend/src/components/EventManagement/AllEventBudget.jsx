...
<>
    ...
    <div class="flex flex-row-reverse space-x-1 space-x-reverse ...">
      <div className="mb-4">
  <button style={{ backgroundColor: '#1FE23F' }} className="block bg-teal-400 hover:bg-teal-600 text-white font-bold uppercase text mx-auto p-2 rounded-lg">
  ...
  <div className="flex justify-center">
    <button style={{ backgroundColor: '#99ccff',marginRight:'20px' }} className="block bg-teal-400 hover:bg-teal-600 text-white font-bold uppercase text mx-auto p-2 rounded-lg" onClick={() =>  toast.error("This event has already been accepted and paid by the financial manager. You cannot edit this.")}>Edit</button>
    <button style={{ backgroundColor: '#ff9980' }} className=" bg-teal-400 hover:bg-teal-600 text-white font-bold uppercase text mx-auto p-2 rounded-lg" onClick={() => toast.error("This event has already been accepted and paid by the financial manager. You cannot delete this.")}>Delete</button>
  </div>
) : (
  <div className="flex justify-center">
    
      <button style={{ backgroundColor: '#459DE8',marginRight:'20px' }} className="block bg-teal-400 hover:bg-teal-600 text-white font-bold uppercase text mx-auto p-2 rounded-lg">
        <Link to={`/eventdashboard/editbudget/${request._id}`}>Edit</Link>
      </button>
    <button style={{ backgroundColor: '#D12222' }} className=" bg-teal-400 hover:bg-teal-600 text-white font-bold uppercase text mx-auto p-2 rounded-lg" onClick={()=>handleDelete(request._id)}>Delete</button>
  </div>
)}
