...
export default function StockRequestEdit(){
  ...
  async function getstock() {
    try {
      const res = await axios.get(`http://localhost:8080/api/eventstock/getstock/${id}`);
...
useEffect(() => {
  ...
  return (
    ...
    <h1 class="block w-full text-center text-white text-2xl font-bold mb-6">Edit Stock Request</h1>
