...
const BudgetRequestForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const request = { eid, budgetid,eventName, items,description,total,status,amountStatus };

    
   

    axios.post("http://localhost:8080/api/eventbudget/reqBudget",request)
    .then(res => {
...
getevents()
  ...
  return (
    ...
    <h1 class="block w-full text-center text-white text-2xl font-bold mb-6">Request Budget</h1>
