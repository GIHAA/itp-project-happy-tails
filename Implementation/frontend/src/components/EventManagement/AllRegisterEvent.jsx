    ...
    const [singleAmount,setSingleAmount] = useState([]);
        ...
        function filterContent(report, searchTerm) {
          ...
          const handleTextSearch = (e) => {
            ...
            axios.get("http://localhost:8080/api/eventregister/getbooking").then((res) => {
         ...
         console.log(amount)
          ...
          Promise.all([
            axios.delete(`http://localhost:8080/api/eventregister/deletebook/${id}`)
...
return(
    ...
    <p style={{backgroundColor:'#D5ABAF'}}>No registered event found.</p>
  )}
</div>
</div>
</>  
