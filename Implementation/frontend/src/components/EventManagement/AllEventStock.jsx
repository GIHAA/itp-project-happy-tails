        ...
        <div class="pb-4 bg-white">
          ...
          <div class="relative mt-1">
            ...
            <input
              ...
              placeholder="Search by Event Name or Event ID or Request ID"
            />
          </div>
        </div>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <div class="flex flex-row-reverse space-x-1 space-x-reverse ...">
            <div>
              ...
              >
                <Link to={"/eventdashboard/addStock"}>Request Stock</Link>
              </button>
            </div>
          </div>
                        ...
                        {request.status === "Accepted" ? (
                          <div className="flex justify-center">
                            <button
                              ...
                              onClick={() =>
                                toast.error(
                                  "This request has already been accepted and cannot be edited"
                                )
                              }
                            >
                              Edit
                            ...
                            <button
                              ...
                              onClick={() =>
                                toast.error(
                                  "This request has already been accepted and cannot be deleted"
                                )
                              }
                            >
                              Delete
                          ...
                          <div className="flex justify-center">
                            ...
                            >
                              <a
                                href={`/eventdashboard/editstock/${request._id}`}
                              >
                                Edit
                              </a>
                            </button>
