...
const GetPayment = () => {
  ...
  const generatePDF = () => {
    ...
    const notify = () => toast.success('Payment Verified ', {
        position: "top-right",
        autoClose: 3000,
        ...
        <>
            ...
            <div class="flex ml-48 justify-center flex-cols-1 gap-4 mt-20 ">
                ...
                <div class="bg-[#2E4960] shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
                    <div class=" flex justify-center items-center gap-4 w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                        <svg width="80" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="stroke-current text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                    </div>
            ...
            <div class="flex -mt-24">
                ...
                <div class="flex ml-80 -mb-4 ">
                    <button type="button" class="   my-12 border border-gray-700 bg-[#2E4960] text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-gray-800 focus:outline-none focus:shadow-outline" onClick={() => { setOpenModal(true) }} >
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                ...
                                {filteredPayData.map((data) => {
                                    const {
                                        ...
                                        _id, cus_id, pet_id, payment, status,
                                    ...
                                    function updateTransaction() {
                                        ...
                                        axios
                                            .put(`http://localhost:8080/api/payment/${_id}`, updatedTransaction)
                                            .then((response) => {
                                    ...
                                    return (
                                        ...
                                        <tr key={_id} class="font-semibold bg-gray-50 dark:bg-gray-100 hover:bg-gray-100 dark:hover:bg-gray-400 text-gray-100 dark:text-gray-900">
                                            ...
                                            <td class="px-8 text-center py-3 text-sm">
                                                <button class="px-2 py-1 font-semibold leading-tight text-yellow-700 bg-green-100 rounded-full dark:bg-yellow-700 dark:text-green-100" onClick={() => { setSelectedData(data); setShowUpdateForm(true); }}> Update  </button>
                                            </td>
                                            <td class="px-8 items-center py-3 text-sm">
                                                <button class="px-2 py-1 font-semibold leading-tight text-red-700 bg-green-100 rounded-full dark:bg-red-700 dark:text-green-100" onClick={() => deleteTransaction(_id)}> Delete  </button>
                                            </td>
                                            <td class="px-8 items-center py-3 text-sm">
                                                <button class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100" onClick={() => { notify(); updateTransaction(); refreshPage(); }}> Verify  </button>
                                            </td>
                                    ...
                                    >
                                        <div key={selectedData?._id}>
                                            ...
                                            <div>
                                                ...
                                                <h2 className="text-4xl my-14 flex justify-center">Update Payment Form</h2>
                                            ...
                                            <div class="mb-3 justify-center -mx-2 flex items-start">
                                                ...
                                                <label class="font-medium text-sm mb-2 ml-1"> Customer Name{" "}
                                                    {
                                                        console.log(selectedData.cus_id)
                                                    }
                                                    <input type="text" name="title" defaultValue={selectedData.cus_id} required class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" /> </label>{" "}
                                                ...
                                                <label class="font-medium text-sm mb-2 ml-1"> Pet ID{" "}
                                                    <input type="text" name="title" defaultValue={selectedData.pet_id} class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" /> </label>{" "}
                                            ...
                                            <div className=" mb-3 justify-center -mx-2 flex items-end ">
                                                ...
                                                <label class="font-medium text-sm mb-2 ml-1"> Payment  {" "} <input type="number" name="pay" defaultValue={selectedData.payment} class="w-3/6 px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" /> </label>{" "} <br />


                                                <br />

                                                <label class="font-medium text-sm mb-2 ml-1"> Status{" "} <select name="target" defaultValue={selectedData.status} className="form-select w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors cursor-pointer">
