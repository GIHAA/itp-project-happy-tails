        ...
        <div class="mb-3 justify-center -mx-2 flex items-end">
          ...
          <label class="font-medium text-sm mb-2 ml-1">
            ...
            <select
              ...
              onChange={(e) => handle(e)}
            >
              <option value="INCOME" selected={data.tran_type === "INCOME"}>
                {" "}
                INCOME{" "}
              </option>
              <option value="EXPENSES" selected={data.tran_type === "EXPENSES"}>
                {" "}
                EXPENSES{" "}
              </option>
            </select>{" "}
        ...
        <div class="mb-3 justify-center -mx-2 flex items-end ">
          <label class="font-medium text-sm mb-2   ">
            ...
            <input
              ...
              onChange={(e) => handle(e)}
              id="tran_amount"
              value={data.tran_amount}
              class="w-5/6 px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
            ></input>{" "}
          </label>{" "}
          <br></br>
          <label class="font-medium text-sm mb-2 ml-1">
            ...
            >
              ...
              <option
                ...
                selected={data.tran_target === "Event Management"}
              >
                {" "}
                Event Management
              </option>
              <option
                ...
                selected={data.tran_target === "Vehicle Management"}
              >
                Vehicle Management
              </option>
              <option
                value="Supplier Management"
                selected={data.tran_target === "Supplier Management"}
              >
                Supplier Management
              </option>
            </select>
        ...
        <div className=" mb-3 justify-center -mx-2 flex items-end ">
          <label class="font-medium text-sm mb-2 ml-1">
            ...
            <select
              ...
              onChange={(e) => handle(e)}
            >
              <option value="CANCEL" selected={data.tran_status === "CANCEL"}>
                Select
              </option>
              <option value="PAID" selected={data.tran_status === "PAID"}>
                PAID
              </option>
            </select>{" "}
          </label>{" "}
