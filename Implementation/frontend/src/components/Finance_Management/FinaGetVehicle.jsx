            ...
            <table class="table-auto rounded-lg ml-80">
              ...
              <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                {filteredPayData.map((data) => {
                  const { _id, req_title, date, payment, status } = data;
                    ...
                    >
                      <td class="px-10 py-2">
                        <div class="flex items-center px-10 py-3 text-sm">
                          <div>
                            <p class="font-semibold">{req_title}</p>
                          </div>
                        </div>
                      </td>

                      <td class="text-center px-10 py-3 text-sm">{payment}</td>

                      <td class="text-center px-10 py-3 text-sm ">{date}</td>
