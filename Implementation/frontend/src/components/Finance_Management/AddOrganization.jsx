  ...
  return (
    <div className="z-50 fixed inset-0 bg-[#2E4960] bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
      ...
      >
        ...
        <div class="mb-3 ml-8 justify-start -mx-20  flex items-end">
          <label class="font-medium text-sm mb-2 ml-1 ">
            ...
            <input
              ...
              class="w-60 px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
            ></input>{" "}
          </label>{" "}
          <br></br>
          ...
          <label class="font-medium text-sm mb-2 ml-1">
            ...
            <select
              ...
              onChange={(e) => handle(e)}
            >
              <option value="Regional" selected={data.org_type === "Regional"}>
                Regional
              </option>
              <option value="Global" selected={data.org_type === "Global"}>
                Global
              </option>
            </select>{" "}
          </label>{" "}
          ...
          <label class="font-medium text-sm mb-2 ml-1">
            ...
            <select
              ...
              onChange={(e) => handle(e)}
            >
              <option value="Small" selected={data.org_Resources === "Small"}>
                {" "}
                Small
              </option>
              <option value="Medium" selected={data.org_Resources === "Medium"}>
                Medium
              </option>
              <option value="Large" selected={data.org_Resources === "Large"}>
                Large
              </option>
            </select>
          </label>
        ...
        <div className=" mb-3 justify-center -mx-2 flex items-end "></div>
        ...
        <div class="mb-3 justify-center -mx-2 flex items-end"></div>

        <div class="float-right">
          <button class=" border-green-500 bg-green-500 text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-green-600 focus:outline-none focus:shadow-outline">
            Submit
          </button>
          <button
